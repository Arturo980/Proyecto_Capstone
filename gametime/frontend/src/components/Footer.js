    ...
    <footer className="bg-dark text-white text-center py-3">
      <div className="container">
        ...
        <p>
          ...
          <a
            href="https://www.tiktok.com/@gametimechile?fbclid=PAQ0xDSwKGM6BleHRuA2FlbQIxMQABp1_trdu-aspPwUD-GFluktkqrC4OueJNOuTG7ZiGB4kG7Q_AIWjQloAWDKIC_aem_7jwPUK_ZEPE16HprldsNjw"
            className="text-white mx-2"
            target="_blank"
            rel="noopener noreferrer"
          >
